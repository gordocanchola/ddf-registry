...
public class RegistryReportHelperTest {
    ...
    private void assertThatRegistryMapHasExpectedValues(Map<String, Object> registryMap) {
        ...
        assertThat(((Map<String, Object>) ((Map<String, Object>) ((Map<String, Object>) registryMap.get(
                "Services")).get("Service")).get("Csw_Federated_Source")).get("cswUrl"),
                is("https://some/address/here"));
