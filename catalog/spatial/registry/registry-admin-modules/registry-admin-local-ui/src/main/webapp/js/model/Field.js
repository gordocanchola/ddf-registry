...
define([
    ...
    Field.FormField = Backbone.AssociatedModel.extend({
        ...
        validate: function() {
            var error;
            var indices = [];
            if(!this.get('value') && !this.get('regex')){
                if(this.hadError){
        ...
        saveData: function(dataModel, ebrimTypes) {
                ...
                if (this.get('type') === 'date') {
                    ...
                    if (this.get('valueLowerLat') && this.get('valueLowerLon') && this.get('valueUpperLon') && this.get('valueUpperLat')) {
                        slot.value = {
                            Envelope: {
                                srsName: '',
                                lowerCorner: this.get('valueLowerLat') + ' ' + this.get('valueLowerLon'),
                                upperCorner: this.get('valueUpperLat') + ' ' + this.get('valueUpperLon')
                            }
                        };
                    }
